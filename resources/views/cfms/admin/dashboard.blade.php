                ...
                <div class="card o-hidden border-0">
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body">
                                <span class="m-0">Create User</span>
                                    ...
                                    <table class="table table-bordernone">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle"
                                                        ...
                                                        <div class="media-body"><a href="#"><span>Sample
                                                                    </span></a></div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td><img class="img-fluid"
                                                        {{-- src="{{ asset('assets/images/dashboard/graph-1.png') }}" --}}
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="img-fluid"
                                                        {{-- src="{{ asset('assets/images/dashboard/graph-2.png') }}" --}}
                                                        alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$548526</p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="img-fluid"
                                                        {{-- src="{{ asset('assets/images/dashboard/graph-3.png') }}" --}}
                                                        alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$589565</p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="img-fluid"
                                                        {{-- src="{{ asset('assets/images/dashboard/graph-4.png') }}" --}}
                                                        alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$125424 </p>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="img-fluid"
                                                        {{-- src="{{ asset('assets/images/dashboard/graph-5.png') }}" --}}
                                                        alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$112103</p>
                                                </td>
