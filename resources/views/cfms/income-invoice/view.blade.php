...
@section('content')
    @component('components.income_breadcrumb')
        ...
        @slot('print_url')
            <li><a href="{{ route('income-invoice.template',$invoice->id) }}" data-container="body" data-bs-toggle="popover" data-placement="top" title="Print" data-original-title="Tables"><i data-feather="printer"></i></a></li>
        @endslot
    @endcomponent
...
@section('customJs')
    <script type="text/javascript">
        ...
        function get_items(item_id){
            ...
            if(item_id){
                $.ajax({
                    url: "<?php echo route('income-invoice.item') ?>",
                    method: 'GET',
