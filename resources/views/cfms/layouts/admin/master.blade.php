...
<body>
    ...
    <div class="page-wrapper compact-sidebar" id="pageWrapper">
        <!-- Page Header Start-->
        @includeIf('cfms.layouts.admin.partials.header')
        <!-- Page Header Ends -->
        <!-- Page Body Start-->
        <div class="page-body-wrapper sidebar-icon">
            <!-- Page Sidebar Start-->
            @includeIf('cfms.layouts.admin.partials.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 footer-copyright">
                            <p class="mb-0">Copyright {{ date('Y') }}-{{ date('y', strtotime('+1 year')) }} © All
                                rights reserved.</p>
                        </div>
                        <div class="col-md-6">
    ...
    <script type="text/javascript">
        function notifyToUser(title, message, message_type) {
            $.notify({
                title: title,
                message: message
            }, {
